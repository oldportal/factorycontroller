...
const char* const  oldportal::fc::hardware::mechatronics::data::StepMotorDriverDataInput::_CLASSNAME_FULL = "oldportal::fc::hardware::mechatronics::data::StepMotorDriverDataInput";
