...
const char* const  oldportal::fc::hardware::metallurgy::data::InductorDriverCalculationConstants::_CLASSNAME_FULL = "oldportal::fc::hardware::metallurgy::data::InductorDriverCalculationConstants";
