...
/**
Request motion state from device.
*/
namespace oldportal 
{
namespace fc 
...
// constructors:
public:
GetMotionState(std::shared_ptr< oldportal::fc::hardware::HardwareDevice > device, std::shared_ptr< oldportal::fc::hardware::HardwareDeviceProcess > device_process);
