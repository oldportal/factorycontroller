...
*    dmogn@mail.ru
*/
#ifndef H_cb94a4923bd4a3883772e5dba61351db_H
#define H_cb94a4923bd4a3883772e5dba61351db_H
...
// constructors:
public:
GetInductorState(std::shared_ptr< oldportal::fc::hardware::HardwareDevice > device, std::shared_ptr< oldportal::fc::hardware::HardwareDeviceProcess > device_process);


public:
virtual ~GetInductorState();
...
#endif // H_cb94a4923bd4a3883772e5dba61351db_H

#ifdef OBJECTS_BUILDER_PROJECT_INLINES
#ifndef H_cb94a4923bd4a3883772e5dba61351db_INLINES_H
#define H_cb94a4923bd4a3883772e5dba61351db_INLINES_H

#endif // H_cb94a4923bd4a3883772e5dba61351db_INLINES_H
