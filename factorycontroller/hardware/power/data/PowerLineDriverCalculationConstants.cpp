...
const char* const  oldportal::fc::hardware::power::data::PowerLineDriverCalculationConstants::_CLASSNAME_FULL = "oldportal::fc::hardware::power::data::PowerLineDriverCalculationConstants";
