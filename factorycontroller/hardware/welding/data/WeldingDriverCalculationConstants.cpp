...
const char* const  oldportal::fc::hardware::welding::data::WeldingDriverCalculationConstants::_CLASSNAME_FULL = "oldportal::fc::hardware::welding::data::WeldingDriverCalculationConstants";
